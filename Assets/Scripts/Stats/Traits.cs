...
namespace RPG.Stats
{
    public class Traits : MonoBehaviour, IModifierProvider, ISaveable
    {
        ...
        private void Awake() 
        {
            ...
            foreach (var bonus in bonusConfig)
            {
                ...
                additiveBonusCache[bonus.stat][bonus.trait] = bonus.additiveBonus;
                percentageBonusCache[bonus.stat][bonus.trait] = bonus.percentageBonus;
            }
        }
